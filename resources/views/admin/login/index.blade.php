        ...
        <form class="form form-horizontal" action="{{ route('admin.login') }}" method="post">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8">
                    <input value="admin" name="username" type="text" placeholder="账户" class="input-text size-L">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-3"><i class="Hui-iconfont">&#xe60e;</i></label>
                <div class="formControls col-xs-8">
                    <input value="admin" name="password" type="text" placeholder="密码" class="input-text size-L">
                </div>
            </div>
            <div class="row cl">
